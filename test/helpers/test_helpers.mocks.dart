...
// in task_sync/test/helpers/test_helpers.dart.
...
import 'package:task_sync/app/models/task_model.dart' as _i8;
import 'package:task_sync/services/api_service.dart' as _i7;
...
class MockApiService extends _i1.Mock implements _i7.ApiService {
  @override
  _i5.Future<List<_i8.TaskModel>> getTasks() => (super.noSuchMethod(
        Invocation.method(
          #getTasks,
          [],
        ),
